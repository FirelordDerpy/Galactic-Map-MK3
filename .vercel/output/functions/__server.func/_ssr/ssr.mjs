...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-rZrXYe2r.mjs");
...
var manifest = { "e99e1476b8e3664785f3e644303f838b2bf22f4499afa239ea3f8cb0689fb613": {
	functionName: "loadGalaxyFn_createServerFn_handler",
	importer: () => import("./load-galaxy-BnpfA6UP.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dx7nssmb.mjs").then((n) => n.t),
